# PDVST 0.41  - 30/01/2018  -   maintained by Jean-Yves Gratius  jyg@gumo.fr 
...
This new version doesn't need a custom version of pure-data. You can use your current pure-data installation (>= 0.47-1) with your favorite externals). 

1) According to your pd version (32 or 64 bits), go to the folder pd-scheduler32 or pd-scheduler64. Copy vstschedlib.dll (& pthreadGC-3.dll) to \bin directory of your current pure-data installation
...
* Create a new .pdv setup file (see the .pdv Setup File section). The file
   ...
   files (.pd files, external Pd library .dll files, etc.) as specified above (section "Installation").
